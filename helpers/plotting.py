    ...
    perf_chart = (
        ...
        .encode(
            x=alt.X(
                ...
                sort="-y",
                axis=alt.Axis(
                    labelAngle=-45,  # Angle the labels by -45 degrees
                    labelAlign="right",  # Align the labels to the right
                    labelBaseline="middle",  # Center the labels vertically
                    labelLimit=150,  # Allow more space for the labels
                    labelOverlap=False,  # Ensure labels don't overlap
                ),
            ),
