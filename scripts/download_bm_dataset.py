...
# target_file = "downloaded_data.nc"
# client = cdsapi.Client()
# client.retrieve(dataset, request).download(target_file)

source_file = "downloaded_data.nc"
chunk_size = (24, 60, 60)  # FIXME: Change chunk size!

print(f"Reading t2m variable from {source_file}...")
...
write_results = bm_write_all_formats(chunk_size=chunk_size, iterations=1, data=t2m_data)
